...
export const PostCreateArgsSchema: z.ZodType<Omit<Prisma.PostCreateArgs, 'data'> & {
  data: 
...
export const PostUpsertArgsSchema: z.ZodType<Omit<Prisma.PostUpsertArgs, 'create' | 'update'> & {
  create:
    | z.infer<typeof PostCreateInputSchema>
    | z.infer<typeof PostUncheckedCreateInputSchema>,
  update:
    | z.infer<typeof PostUpdateInputSchema>
    | z.infer<typeof PostUncheckedUpdateInputSchema>,
}> = z.object({
  select: PostSelectSchema.optional(),
  include: PostIncludeSchema.optional(),
  where: PostWhereUniqueInputSchema,
...
export const PostUpdateArgsSchema: z.ZodType<Omit<Prisma.PostUpdateArgs, 'data'> & {
  data:
    | z.infer<typeof PostUpdateInputSchema>
    | z.infer<typeof PostUncheckedUpdateInputSchema>,
}> = z.object({
